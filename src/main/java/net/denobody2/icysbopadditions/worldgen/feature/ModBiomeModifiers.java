package net.denobody2.icysbopadditions.worldgen.feature;
...
public class ModBiomeModifiers {
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(IcysBOPAdditions.MOD_ID, name));
    }
}
